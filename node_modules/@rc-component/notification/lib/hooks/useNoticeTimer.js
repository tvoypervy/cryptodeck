...
var _raf = _interopRequireDefault(require("@rc-component/util/es/raf"));
var _useEvent = _interopRequireDefault(require("@rc-component/util/es/hooks/useEvent"));
...
function useNoticeTimer(duration, onClose, onUpdate) {
  ...
  const onEventClose = (0, _useEvent.default)(onClose);
  const onEventUpdate = (0, _useEvent.default)(onUpdate);
